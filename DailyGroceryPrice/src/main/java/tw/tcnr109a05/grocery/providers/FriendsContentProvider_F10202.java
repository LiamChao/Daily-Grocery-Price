...
public class FriendsContentProvider_F10202 extends ContentProvider {
    private static final String AUTHORITY = "tw.tcnr109a05.grocery.f10202";
    private static final String DB_FILE = "F10202.db", DB_TABLE = "fish";
    ...
    private static final String crTBsql = "CREATE TABLE " + DB_TABLE + " ( "
            + "ID INTEGER PRIMARY KEY," + "Fish TEXT ," + "Market TEXT," + "Avgprice DECIMAL," + "Tradedate TEXT);";
